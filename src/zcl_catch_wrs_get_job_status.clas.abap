CLASS zcl_catch_wrs_get_job_status DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_catch_wrs_get_job_status IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA jobstatus        TYPE cl_apj_rt_api=>ty_job_status.
    DATA jobstatustext    TYPE cl_apj_rt_api=>ty_job_status_text.

    DATA lt_original_data TYPE STANDARD TABLE OF zc_catch_wm_repl_sel WITH DEFAULT KEY.
    ...
    LOOP AT lt_original_data ASSIGNING FIELD-SYMBOL(<fs_original_data>).
      ...
      TRY.
          ...
          IF <fs_original_data>-JobName IS NOT INITIAL AND <fs_original_data>-JobCount IS NOT INITIAL.
            ...
            cl_apj_rt_api=>get_job_status( EXPORTING iv_jobname         = <fs_original_data>-JobName
                                                     iv_jobcount        = <fs_original_data>-JobCount
                                           IMPORTING ev_job_status      = JobStatus
